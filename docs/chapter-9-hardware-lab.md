...
3. **Robots**
   - Unitree Go2 or G1  
   - Humanoid or quadruped robots for testing  

---

## Lab Setup Options
1. **Proxy / Budget Lab**
   - Use quadruped or robotic arm  
   - Affordable and durable  
2. **Miniature Humanoid Lab**
   - Small humanoid robots for kinematics  
3. **Premium Lab**
...
## Summary
- High-performance workstation needed for simulation  
